...
def train_one_epoch(
    ...
    for i, batch in enumerate(dataloader):
        ...
        # TODO: instead of images, process 3d CT volume here -> form the middle slice, get 5 on both sides.
        # a total of 10 slices and batch it as ---> batch_size, num_frames, c, h, w = video_frames.shape
        images, texts = batch
